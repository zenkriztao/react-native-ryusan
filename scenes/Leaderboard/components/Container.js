        ...
        <View style={styles.selectionView}>
            <TouchableOpacity onPress={() => selectLeaderboardType(LEADERBOARD_TYPE.THIS_WEEK)}>
              <View style={[
                ...
                <Text style={[styles.buttonText, { color: leaderBoardType === LEADERBOARD_TYPE.THIS_WEEK ? COLORS.APP_WHITE : 'grey' }]}>Saat Ini</Text>
              </View>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => selectLeaderboardType(LEADERBOARD_TYPE.ALL_TIME)}>
              <View style={[
                ...
                <Text style={[styles.buttonText, { color: leaderBoardType === LEADERBOARD_TYPE.ALL_TIME ? COLORS.APP_WHITE : 'grey' }]}>Semua Waktu</Text>
              </View>
            </TouchableOpacity>
          </View>
