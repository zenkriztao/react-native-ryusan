...
export default class Container extends PureComponent {
  ...
  askForLogout() {
    Alert.alert('Kamu Yakin Ingin Keluar?', '', [{
      text: 'cancel',
    },
    {
      text: 'logout',
  ...
  submitAction() {
    ...
    if (question === '' || question.length < 3) {
      Alert.alert('PERHATIAN!!', 'Mohon Masukkan Pertanyaan Yang Benar')
      return
    }
    if (answer === '' || answer.length < 1) {
      Alert.alert('PERHATIAN!!', 'Mohon Masukkan Jawaban Yang Benar')
      return
    }
    if (aOptionValue === '' || aOptionValue.length < 1) {
      Alert.alert('PERHATIAN!!', 'Mohon Masukkan Benar A Pilihan')
      return
    }
    if (aOptionValue === '' || bOptionValue.length < 1) {
      Alert.alert('PERHATIAN!!', 'Mohon Masukkan Benar B Pilihan')
      return
    }
    ...
    if (options === 'Pilih Kategori' || options.length < 1) {
      Alert.alert('PERHATIAN!!', 'Mohon Pilih Kategori Yang Benar')
      return
    }
      ...
      <View style={styles.container}>
        <View style={styles.navBar}>
          ...
          <View style={styles.headerView}>
            <Text style={styles.headerText}>Kunjungi budaya_heroes</Text>
          </View>
        ...
        >awarded
          <Text style={styles.userNameText}>{'Kamu Mendapatkan:'}</Text>
        ...
        {/* </View> */}
          ...
          >Earn more budaya_heroes reward coins by simply submitting a fact or specific think you like into an intriguing question, with proper grammar and spelling. 
          </Text>
            </View>
</View>
        <View style={[styles.containerView, {marginTop: 0}]}>
          ...
          onPress={() => this.submitAction()}>
            {/* <View style={styles.submitView}> */}
              <Text style={styles.submitText}>Tekan</Text>  
            {/* </View> */}
          </TouchableOpacity>
