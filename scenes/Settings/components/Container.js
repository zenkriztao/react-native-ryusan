...
export default class Container extends PureComponent {
  ...
  showSumbitButton () {
    ...
    onPress={() => this.submitAction()}>
       <View style={styles.submitView}> 
        <Text style={styles.submitText}>Klik</Text>  
       </View> 
    </TouchableOpacity>
    )
}
  ...
  informationAbout() {
   // Alert.alert('Kata Sandi', `Enter a friend's SK username as your referral code.`)
  }
  askForLogout() {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.containerView}>
          ...
          <Text style={styles.referalHeaderText}>Masukkan Kata Sandi Sebelumnya</Text>
